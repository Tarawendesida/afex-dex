...
- Fund name: `EGYEX Fund`
- Full name: `Egypt Raw Export Index Fund`
- Benchmark: `Egypt Raw Export Index`
- Fund family: `AFEX`
...
- Egypt should combine energy, mining, and agricultural export logic.
