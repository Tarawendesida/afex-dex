...
- Fund name: `MAREX Fund`
- Full name: `Morocco Raw Export Index Fund`
- Benchmark: `Morocco Raw Export Index`
- Fund family: `AFEX`
...
- Morocco should emphasize phosphates and fisheries while carrying a diversified-coastal profile.
