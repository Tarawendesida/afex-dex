...
- Fund name: `LBYEX Fund`
- Full name: `Libya Raw Export Index Fund`
- Benchmark: `Libya Raw Export Index`
- Fund family: `AFEX`
...
- Libya should be treated as a highly concentrated energy benchmark.
