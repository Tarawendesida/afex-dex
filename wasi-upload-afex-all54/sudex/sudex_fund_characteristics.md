...
- Fund name: `SUDEX Fund`
- Full name: `Sudan Raw Export Index Fund`
- Benchmark: `Sudan Raw Export Index`
- Fund family: `AFEX`
...
- Sudan should combine mining and agricultural export logic with a conflict-risk caution.
